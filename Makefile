...
AQV6_OBJS := 1wire.o adc.o algebra.o aq_init.o aq_mavlink.o aq_timer.o \
...
# ARM
DSPLIB_OBJ_FILES = arm_fill_f32.o arm_copy_f32.o arm_mat_init_f32.o arm_mat_inverse_f32.o arm_mat_trans_f32.o arm_mat_mult_f32.o arm_mat_add_f32.o arm_mat_sub_f32.o arm_mean_f32.o arm_std_f32.o
...
## all objects
C_OBJECTS := $(addprefix $(OBJ_PATH)/, $(AQV6_OBJS) $(STM32_SYS_OBJS) $(COOS_OBJS) $(DSPLIB_OBJS) $(FATFS_OBJS))
