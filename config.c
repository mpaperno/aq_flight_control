...
void configLoadDefault(void) {
    ...
    p[COMM_STREAM_TYPE1] = DEFAULT_COMM_STREAM_TYPE1;
    p[COMM_STREAM_TYPE2] = DEFAULT_COMM_STREAM_TYPE2;
    p[COMM_STREAM_TYPE3] = DEFAULT_COMM_STREAM_TYPE3;
    p[COMM_STREAM_TYPE4] = DEFAULT_COMM_STREAM_TYPE4;
