...
void configLoadDefault(void) {
    ...
    p[GMBL_PWM_MAX_ROLL] = DEFAULT_GMBL_PWM_MAX_ROLL;
    p[GMBL_PWM_MIN_ROLL] = DEFAULT_GMBL_PWM_MIN_ROLL;
    p[GMBL_PWM_MAX_PITCH] = DEFAULT_GMBL_PWM_MAX_PITCH;
    p[GMBL_PWM_MIN_PITCH] = DEFAULT_GMBL_PWM_MIN_PITCH;
