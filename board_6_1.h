...
#define DIUM_EEPROM_SPI		    SPI2
#define DIUM_EEPROM_CS_PORT	    GPIOB
#define DIUM_EEPROM_CS_PIN	    GPIO_Pin_12

#define DIUM_HMC5983_SPI	    SPI2
#define DIUM_HMC5983_CS_PORT	    GPIOD
#define DIUM_HMC5983_CS_PIN	    GPIO_Pin_10
#define DIUM_HMC5983_INT_PORT	    GPIOE
#define DIUM_HMC5983_INT_PIN	    GPIO_Pin_2
#define DIUM_HMC5983_INT_EXTI_PORT  EXTI_PortSourceGPIOE
#define DIUM_HMC5983_INT_EXTI_PIN   EXTI_PinSource2
#define DIUM_HMC5983_INT_EXTI_LINE  EXTI_Line2
#define DIUM_HMC5983_INT_EXTI_IRQ   EXTI2_IRQn
#define DIUM_HMC5983_INT_ISR	    EXTI2_IRQHandler

#define DIUM_MS5611_CS_PORT	    GPIOE
#define DIUM_MS5611_CS_PIN	    GPIO_Pin_7
#define DIUM_MS5611_SPI		    SPI2

#define DIUM_MPU6000_SPI	    SPI2
#define DIUM_MPU6000_CS_PORT	    GPIOD
#define DIUM_MPU6000_CS_PIN	    GPIO_Pin_4

#define DIUM_MPU6000_INT_PORT	    GPIOD
#define DIUM_MPU6000_INT_PIN	    GPIO_Pin_6
#define DIUM_MPU6000_INT_EXTI_PORT  EXTI_PortSourceGPIOD
#define DIUM_MPU6000_INT_EXTI_PIN   EXTI_PinSource6
#define DIUM_MPU6000_INT_EXTI_LINE  EXTI_Line6
